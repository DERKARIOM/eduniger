...
class DetacheStructureApi {
  static const String baseUrl = 'https://eduniger.com/api';
  static const String loginEndpoint = '/detach_struct.php';

  static Future<AuthResponse> detacher({
    ...
    try {
      ...
      if (responseBody == "true") {
        ...
        return AuthResponse(
          status: 'error',
          message: 'Vous êtes déjà detacher à cette structure',
            code: 404);
